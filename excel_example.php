<?php
	...
	$myArr=array("ID","Docente","Cargo","CUIL", "Horas", "Situación de Revista", utf8_decode("Sección"));
	...
	while ( $docente->fetch() ){
		$docente->getLinks();
		$arr = array($docente->doc_id, $docente->doc_nombre, $docente->doc_cargo, $docente->doc_cuil, $docente->doc_hs, $docente->doc_revista, $docente->_doc_seccion->sec_nombre);
		$excel->writeLine($arr);
